# Credit to csredino
# https://github.com/csredino/Box-Office-Mojo-Scrapper
...
def crawlToCSV(url):
    try:
        ...
        current_url = (url + "&adjust_yr=2017&p=.htm")
        
		#do all movies in 2015 dollars (done automatically by site with correct URL)
